...
export const profiles = [
    {
        ...
        verb: "Inspiring",
        spiel: <>
            <p>Our standard mead imparts the inspiring energy of the rune, Ansuz, to enhance connections, wisdom and understanding with out Higher Power.</p>
        ...
        verb: "Illuminating",
        spiel: <>
            <p>Our Applie-Spiced Mead <span className="red"><em>Warms</em></span> and <span className="red"><em>Illuminated</em></span> the way with KENAZ's energy like that of a torch dispelling darkness and serving as a beacon of wisdom in a world filled with uncertainty.</p>
            <p>Cimplimenting our fresh apples is whole cinammon, coarsely ground nutmeg, and other warming spices!</p>
        </>,
        ...
        spiel: <>
            ...
            <p>SWEET GALE (or BOG MYRTLE) - Bog Myrtle has a long history of use in traditional medicine and cuisine. The leaves and berries of the plant contain a number of bioactive compounds, including tannins, flavonoids, and essential oils, that are believed to have a range of health benefits. Box Myrtle has been used to treat digestive issues, respiratory infections, and skin conditions.</p>
        </>,
        ...
        verb: "Transforming",
        spiel: <>
            <p>In Norse tradition, the winter solstice was celebrated during the "Yule" with a festival marking the shortest day and the longest night. Yule was a time of cenebration and spiritual reflection... and the forthcoming renewal of life the New Year would bring.</p>
